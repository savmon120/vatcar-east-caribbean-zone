...
class Oauth2ClientPluginManager extends DefaultPluginManager {
  ...
  public function __construct(
    ...
    parent::__construct('Plugin/Oauth2Client', $namespaces, $moduleHandler, Oauth2ClientPluginInterface::class, Oauth2Client::class, 'Drupal\oauth2_client\Annotation\Oauth2Client');
  ...
  protected function getDiscovery() {
    if (!($this->discovery instanceof Oauth2ClientDiscoveryDecorator)) {
